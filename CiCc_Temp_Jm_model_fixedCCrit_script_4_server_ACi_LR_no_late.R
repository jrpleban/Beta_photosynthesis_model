...
##  model based generally on Farqhuar, von Caemmerer and Berry Planta (1980)
##  also as decribed in Sharkey Fitting photosynthetic carbon dioxide response curves for C3 leaves PCE  (2007)
########################################################################
########################################################################
...
#source("Full_model_scripts/CiCc_Temp_Jm_model_H.R")
