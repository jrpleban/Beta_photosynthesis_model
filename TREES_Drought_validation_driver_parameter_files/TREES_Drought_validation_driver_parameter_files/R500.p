...
0.2	zh_factor, 7.19
0.0292 0.001 0.010      Rd_mult, Rd=Rd_mult*Vcmax
2.1 3.27 3.0    Jmax_mult, ratio of Jmax to Vcmax
0.80 0.7 0.99     thetaJ, curvature parameter
0.3 0.3964    phiJ_sun, quantum yield, e-/photon
0.072 0.01 0.5   phiJ_shd, quantum yield, e-/photon
0.001 0.0012 0.0900    Nleaf
...
0.180 0.100 5.00 	Gsref
0.487439 0.36 0.61  	m (proportion of Gsref)
-0.05   Md
-0.17 -1.0 -1.6 midday_at_sat_kl
0.5 0.5 3.0 e_at_saturated_kl
4.0 rhizosphere_width_(mm)
0.001 E_inc(Sperry98_pg351_last_para.)
4 soilshells
1800 timestep's(seconds)
...
60.0 initial_conductivity(root)
...
1 N treatment 1-high 2 -low
0 snowpack_water_equivalent, m
0 snowpack_E_deficit_max, deg C
