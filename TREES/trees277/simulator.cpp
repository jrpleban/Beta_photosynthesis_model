...
//call simulations functions for current time step
			...
			fluxout << simOut.A_sun << '\t' << simOut.A_shd << '\t' <<  simOut.Av << '\t' << simOut.Aj <<  '\t' << simOut.L_sun << '\t' << simOut.L_shd << '\t' << simOut.T_sun << '\t' << simOut.T_shd << '\t' << simOut.D0_sun << '\t' << simOut.D0_shd << '\t' << simOut.Ci_sun << '\t' << simOut.Ci_shd << '\t' << simOut.PAR_sun << '\t' << simOut.PAR_shd << '\t' << simOut.gs_sun << '\t' << simOut.gs_shd << '\t' << simOut.NEE << '\t';
